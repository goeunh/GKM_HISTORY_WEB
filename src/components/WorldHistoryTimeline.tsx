...
interface WorldHistoryTimelineProps {
  items: TimelineItem[];
  isAdmin?: boolean;
...
export default function WorldHistoryTimeline({ items, isAdmin, onEdit, onDelete }: WorldHistoryTimelineProps) {
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl font-bold">거시적 흐름 (Macro Trends)</h3>
        </div>
